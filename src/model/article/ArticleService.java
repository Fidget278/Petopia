...
public class ArticleService {
	...
	public ArrayList<ArticleVo> retrieveSearchArticle(int board_no, int startRow, int articlePerPage, String keyfield,
		...
		ArrayList<ArticleVo> articles = ArticleDao.getInstance().selectSearchArticle(board_no, startRow, articlePerPage, keyfield, keyword);
		return articles;
	}
	
	public int retrieveTotalSearchArticle(int board_no, String keyfield, String keyword) throws Exception {
		return ArticleDao.getInstance().selectSearchTotalPostCount(board_no,keyfield, keyword);
	}
