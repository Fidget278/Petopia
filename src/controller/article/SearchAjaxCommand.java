...
public class SearchAjaxCommand implements Command {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<ArticleVo> searchArticle = new ArrayList<ArticleVo>();

		searchArticle = ArticleService.getInstance().retrieveSearchArticle(board_no, startRow, POST_PER_PAGE,
				keyfield, keyword);
		...
		int searchTotalarticle = ArticleService.getInstance().retrieveTotalSearchMember(keyfield, keyword);
